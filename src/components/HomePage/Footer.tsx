...
import { Facebook, Linkedin, Twitter, Youtube, Instagram, Apple, } from "lucide-react"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm">
                            ...
                            <li><Link href="#">Talent Marketplace</Link></li>
                            <li><Link href="#">Project Catalog</Link></li>
                            <li><Link href="#">Hire an agency</Link></li>
                            <li><Link href="#">Enterprise</Link></li>
                            <li><Link href="#">Any Hire</Link></li>
                            <li><Link href="#">Contract-to-hire</Link></li>
                            <li><Link href="#">Direct Contracts</Link></li>
                            <li><Link href="#">Hire worldwide</Link></li>
                            <li><Link href="#">Hire in the USA</Link></li>
                        </ul>
                    </div>
                    <div>
                        <h3 className="font-semibold text-gray-900 mb-3">For Talent</h3>
                        <ul className="space-y-2 text-sm">
                            <li><Link href="#">How to find work</Link></li>
                            <li><Link href="#">Direct Contracts</Link></li>
                            <li><Link href="#">Find freelance jobs worldwide</Link></li>
                            <li><Link href="#">Find freelance jobs in the USA</Link></li>
                            <li><Link href="#">Win work with ads</Link></li>
                            <li><Link href="#">Exclusive resources with Freelancer Plus</Link></li>
                        </ul>
                    </div>
                    <div>
                ...
                <div className="mt-12 pt-8 border-t border-gray-200">
                    <div className="flex flex-wrap justify-between items-center">
                        ...
                        <div className="flex space-x-4 mb-4 md:mb-0">
                            <Link href="#" className="flex items-center border border-gray-300 rounded-md px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50">
                    ...
                    <div className="mt-8 flex flex-col md:flex-row justify-between items-center">
                        ...
                        <nav className="flex flex-wrap justify-center space-x-6 mt-4 md:mt-0">
                            ...
                            <Link href="#" className="text-sm text-gray-500 hover:text-gray-900">CA Notice at Collection</Link>
                            <Link href="#" className="text-sm text-gray-500 hover:text-gray-900">Cookie Settings</Link>
                            <Link href="#" className="text-sm text-gray-500 hover:text-gray-900">Accessibility</Link>
                        </nav>
                    </div>
                </div>
            </div>
